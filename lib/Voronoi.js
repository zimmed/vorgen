...
var sortWByH = function (h) { return function (_a, _b) {
    var _c = _a.def, _d = _c.weight, aW = _d === void 0 ? 1 : _d, _e = _c.maxRadius, aM = _e === void 0 ? 0 : _e, a = __rest(_a, ["def"]);
    var _f = _b.def, _g = _f.weight, bW = _g === void 0 ? 1 : _g, _h = _f.maxRadius, bM = _h === void 0 ? 0 : _h, b = __rest(_b, ["def"]);
    var dx = h(a);
    var dy = h(b);
...
var Voronoi = /** @class */ (function () {
    ...
    Voronoi.generateWeightedPoints = function (grid, rand, types, split, n) {
        ...
        var _a = types
            .sort(function (_a, _b) {
            var _c = _a.weight, a = _c === void 0 ? 1 : _c;
            var _d = _b.weight, b = _d === void 0 ? 1 : _d;
