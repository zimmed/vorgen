...
var Generator = /** @class */ (function () {
    ...
    Generator.randomizedEdgePoints = function (width, height, _a) {
        ...
        var rand = prando || new prando_1.default(seed);
    ...
    Generator.createGrid = function (width, height, terrainDef, _a) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_s) {
                switch (_s.label) {
                    case 0:
                        rand = prando || new prando_1.default(seed);
                        return [4 /*yield*/, Voronoi_1.default.generateTypedGridAsync(width, height, terrainDef, { prando: rand, heuristic: heuristic, split: split, numPoints: numPoints })];
                    case 1:
                        grid = (_s.sent());
                    ...
                    case 2:
                        ...
                        return [4 /*yield*/, Voronoi_1.default.applyNumberedDefAsync(grid, defs, {
                                onlyOnType: cellType,
                                prando: rand,
                    ...
                    case 4:
                        ...
                        return [4 /*yield*/, Voronoi_1.default.applyManualPlotAsync(grid, def[0], def.slice(1), {
                                onlyOnType: cellType,
                                heuristic: heuristic,
                            })];
                    case 5:
                    ...
                    case 11:
                        ...
                        _ = _m[_l];
                        return [4 /*yield*/, Voronoi_1.default.expandGridAsync(grid, {
                                prando: rand,
